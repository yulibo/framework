...
class JSSDK {
  ...
  private $appSecret;
   ...
   //const filedir = 'D:/www/womall-new';
   const filedir = '/data/womall';
  ...
  private function getJsApiTicket() {
	...
	$jsapi_ticket_file = self::filedir.'/weixinfiles/'."jsapi_ticket.json";
  ...
  private function getAccessToken() {
	...
	$access_token_file = self::filedir.'/weixinfiles/'."access_token.json";
